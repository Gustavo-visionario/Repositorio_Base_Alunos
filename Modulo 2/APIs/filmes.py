filmes={
    ...
    "guerra": ["Rambo","1917","Até o Último Homem"],
     "romance": ["para sempre","o verao","amor sem fim","o beijo","legalmente loira"],
    "terror": ["anabele","chucky","chorona","a entidade","a freira"],
    "açao": ["o corvo","blindado","zona de risco","kill","casablanca"],
    "aventura":["moana","na selva","avatar","rango","a origem"],
    "fantasia":["magico de oz","coraline","abracadabra","malevola","matilda"],
}
